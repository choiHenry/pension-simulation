...
def simulate(outFileName, rp_subsidy=True):
    ...
    pension_1970_group_1 = Pension(df_1970_group_1, rp_entitlement_year=2025, rp_subsidy=rp_subsidy)
    pension_1970_group_2 = Pension(df_1970_group_2, military_year=1991, rp_entitlement_year=2026, rp_subsidy=rp_subsidy)
    pension_1970_group_3 = Pension(df_1970_group_3, rp_entitlement_year=2025, rp_subsidy=rp_subsidy)
    pension_1970_group_4 = Pension(df_1970_group_4, delivery_year=1999, rp_entitlement_year=2035, rp_subsidy=rp_subsidy)
    pension_1970_group_5 = Pension(df_1970_group_5, military_year=1990, rp_entitlement_year=2031, rp_subsidy=rp_subsidy)
    pension_1970_group_6 = Pension(df_1970_group_6, delivery_year=1999, rp_entitlement_year=2031, rp_subsidy=rp_subsidy)
    ...
    pension_1980_group_1 = Pension(df_1980_group_1, rp_entitlement_year=2035, rp_subsidy=rp_subsidy)
    pension_1980_group_2 = Pension(df_1980_group_2, military_year=2001, rp_entitlement_year=2036, rp_subsidy=rp_subsidy)
    pension_1980_group_3 = Pension(df_1980_group_3, rp_entitlement_year=2035, rp_subsidy=rp_subsidy)
    pension_1980_group_4 = Pension(df_1980_group_4, delivery_year=2009, rp_entitlement_year=2045, rp_subsidy=rp_subsidy)
    pension_1980_group_5 = Pension(df_1980_group_5, military_year=2000, rp_entitlement_year=2041, rp_subsidy=rp_subsidy)
    pension_1980_group_6 = Pension(df_1980_group_6, delivery_year=2009, rp_entitlement_year=2041, rp_subsidy=rp_subsidy)
    ...
    pension_1990_group_1 = Pension(df_1990_group_1, rp_entitlement_year=2045, rp_subsidy=rp_subsidy)
    pension_1990_group_2 = Pension(df_1990_group_2, military_year=2011, rp_entitlement_year=2046, rp_subsidy=rp_subsidy)
    pension_1990_group_3 = Pension(df_1990_group_3, rp_entitlement_year=2045, rp_subsidy=rp_subsidy)
    pension_1990_group_4 = Pension(df_1990_group_4, delivery_year=2019, rp_entitlement_year=2055, rp_subsidy=rp_subsidy)
    pension_1990_group_5 = Pension(df_1990_group_5, military_year=2010, rp_entitlement_year=2051, rp_subsidy=rp_subsidy)
    pension_1990_group_6 = Pension(df_1990_group_6, delivery_year=2019, rp_entitlement_year=2051, rp_subsidy=rp_subsidy)
    ...
    pension_2000_group_1 = Pension(df_2000_group_1, rp_entitlement_year=2055, rp_subsidy=rp_subsidy)
    pension_2000_group_2 = Pension(df_2000_group_2, military_year=2021, rp_entitlement_year=2056, rp_subsidy=rp_subsidy)
    pension_2000_group_3 = Pension(df_2000_group_3, rp_entitlement_year=2055, rp_subsidy=rp_subsidy)
    pension_2000_group_4 = Pension(df_2000_group_4, delivery_year=2029, rp_entitlement_year=2065, rp_subsidy=rp_subsidy)
    pension_2000_group_5 = Pension(df_2000_group_5, military_year=2020, rp_entitlement_year=2061, rp_subsidy=rp_subsidy)
    pension_2000_group_6 = Pension(df_2000_group_6, delivery_year=2029, rp_entitlement_year=2061, rp_subsidy=rp_subsidy)
